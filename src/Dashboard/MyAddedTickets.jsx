          ...
          {tickets.map((ticket) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="text-gray-600 mb-1">
                  <span className="font-semibold">Price:</span> {ticket.price} × {ticket.quantity}
                </p>
                <p className="text-gray-600 mb-1">
                  <span className="font-semibold">Total:</span> {ticket.total}
                </p>
                <p className="text-gray-600 mb-3">
                  <span className="font-semibold">Date & Time:</span> {ticket.date} | {ticket.time}
                </p>

                <div className="flex gap-3">
                  <button className="flex-1 btn btn-sm bg-blue-500 hover:bg-blue-600 text-white">
                    Edit
                  </button>
                  <button onClick={()=>handleDelete(ticket._id)} className="flex-1 btn btn-sm bg-red-500 hover:bg-red-600 text-white">
                    Delete
                  </button>
                </div>
              </div>
